...
class Controller
{
    ...
    public function render($layout, $view, $params)
    {
        ...
        $params['url'] = $this -> url;
        // On embarque avec nous dans toutes les pages la variable $url qui contient l'url du site, parametré dans app/Config/parameters.php
        ...
        //-----------
        ob_start(); // Enclenche la temporisation de sortie. C'est à dire que ce qui va suivre ne sera pas exécuté tout de suite mais temporisé (retenu en memoire tampon).
        require $path_view;
